...
## 🛠️ Features
- Smart system that dont let user put morethan 12 in month
- Using inteligent system for first four numbers to recognize the bank
- Animaitions
- Built with only HTML & CSS3 & JavaScript
...
- Using Functions
- Improved selecting skills
- Using animations
- Learned Randomising

## 🧬 Credits
Idea by : Shopping sites
